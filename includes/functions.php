...
function insertPetSQL($connection, $nomePet, $raca, $sexo, $faixa, $tipo, $porte, $desc, $cdUsuario) {
    $query = "INSERT INTO PET (cdPet, nmPet, nmRacaPet, icSexoPet, nmFaixaEtariaPet, nmTipoPet, nmPortePet, descPet, cdUsuario) VALUES ('', '$nomePet', '$raca', '$sexo', '$faixa', '$tipo', '$porte', '$desc', $cdUsuario)";
