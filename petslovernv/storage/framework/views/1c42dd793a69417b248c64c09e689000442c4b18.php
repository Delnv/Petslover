                ...
                <div class="conteudo">
                    ...
                    <div class="divesq"> <!-- precisa do cadastrar pet tambem-->
                       ...
                       <?php echo e(csrf_field()); ?>              
                           ...
                           <label class="campos">Imagens de até 2MB</label>
                             <div id="imgs">                               
                                <a href="#">
                                <img src="<?php echo e(asset('image/padrao.jpg')); ?>" class="imgsPetCad" id="foto" >
                                <img src="<?php echo e(asset('image/padrao.jpg')); ?>"  class="imgsPetCad" id="foto2">
                                <img src="<?php echo e(asset('image/padrao.jpg')); ?>" class="imgsPetCad" id="foto3">
                                <img src="<?php echo e(asset('image/padrao.jpg')); ?>" class="imgsPetCad" id="foto4">
                                <img src="<?php echo e(asset('image/padrao.jpg')); ?>" class="imgsPetCad" id="foto5">                                   
                                </a>
                              </div>
                              <div>
                    ...
                    <div class="divdir">
                         ...
                         <label class="campos">Imagens de até 2MB</label>
                             <div id="fotos">
                                <a href="#">
                                <img src="<?php echo e(asset('image/user_photo/photo_padrao.png')); ?>" class="imgsPetCad" id="foto" >
                                </a>
                              </div>
                              <div>
                    ...
                    <div class="divHorizontal">
                            ...
                            <div align="center"> <img src="<?php echo e(asset('image/ad/ad5.png')); ?>"> </div>
                    </div>    
               </div>
