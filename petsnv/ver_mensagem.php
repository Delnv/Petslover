...
$sql = "SELECT i.imPet1, p.cdPet, p.nmPet, m.descMensagem
    FROM IMAGEM_PET i, PET p, MENSAGEM m 
    WHERE i.cdPet = p.cdPet AND p.cdPet = m.cdRemetente 
                ...
                <table align="center" width="520">
                    <tr>
                        ...
                        <td align="center">
                            ...
                            <!--<strong><?php echo $assunto; ?></strong><br><br> -->
                        ...
                        <td colspan="2">
                           <br/>
                            <table align="center" width="450" id="mens-itself">
                               <tr><td align="center" colspan="2"> <?php echo $descricao; ?><td></tr>
                            </table>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="2">
                           <br>
                            <textarea style="font-align:justify;" tabindex="1" id="mensagem" name="mensagem" cols="65" rows="6" maxlength="1000" autofocus>
                            </textarea></td><tr>
                    <tr>
                        <td colspan="2">
                            <label class="dois" style="">
                                OBS: O Pet'sLover não divulga e-mail e dados animais de seus clientes.<br>
                    ...
                    <tr>
                        <td colspan="2" align="center">
                           <br><br>      
                            <button align="center" id="env" name="enviar" tabindex="2" class="btsMsgs" value="<?php echo $cd; ?>">Enviar Resposta</button></td></tr>
                        </td>
                    </tr>
                </table>
            </form>
