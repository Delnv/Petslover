...
if ($_SESSION['logado'] == 'SIM'):
    ...
    echo "<script>alert('Logado com sucesso!'); window.location.href='perfil.php';</script>";// inseri esta linha para qdo logado o usuario sera enviado para a pag de perfil 12-12-17
    echo json_encode($retorno);
    exit();
else:
