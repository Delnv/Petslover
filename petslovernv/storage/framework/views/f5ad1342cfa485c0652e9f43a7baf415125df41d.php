...
<div class="container" style="">
  <section>
      ...
      <p class="paragrafos" style="color:  #0000CD" align="center"><b>Perfil de <?php echo e($usuario->nmUsuario); ?></b></p><br>
      </div>
      <div class="conteudo" style=''> <!-- 1200/1349-->
        ...
        <div class="divesq" style=""> <!-- 600 / 1312-->
          ...
          <p>
           <img src="<?php echo e(asset($usuario->imgUsuario)); ?>" class="imgsPerfil" id="foto">&nbsp;          
           <label class="campos2" style="padding:0;"><?php echo e($usuario->nmUsuario); ?></label>
          </p>

          <hr class="line">
          <label class="campos2">E-mail </label>
          <p class="eco"> <?php echo e($usuario->nmEmail); ?> </p>

          <label class="campos2">CEP </label>
          <p class="eco">
              <?php if(!is_null($usuario->cdCep) OR !empty($usuario->cdCep)): ?>
                  <?php echo e($usuario->cdCep); ?>
          ...
          <div id="todas">
            ...
            <div>
              ...
              <span style=" margin-left: 19px;">
                ...
                <input type="text" style="color:#708090" name="tnm_usuario" size="29" pattern="^[A-Za-záàâãéèêíïóôõöúçñÁÀÂÃÉÈÍÏÓÔÕÖÚÇÑ -]+$" maxlength="150" tabindex="9" value="<?php echo e($usuario->nmUsuario); ?>"/><br>

                <label class="campos3">Alterar CEP</label><br>
                <?php if(!is_null($usuario->cdCep) OR !empty($usuario->cdCep)): ?>
                  <input type='text' style="color:#708090" name='tcd_cep'
                 value="<?php echo e($usuario->cdCep); ?>" maxlength='9' title='Somente números' OnKeyPress="formata('#####-###', this)" pattern='^[0-9]{5}-[0-9]{3}$' size="29" tabindex="10"/><br>
                <?php else: ?>
                  <input type='text' style="color:#708090" name='tcd_cep'
                ...
                value="<?php echo e($usuario->nmEmail); ?>"/><br>
             ...
             <hr class="line">
             <p align="center"><img src="<?php echo e(asset('image/logo1.png')); ?>"></p>
       ...
       <div id="perfil" align="left" class="divdir bordaPerfil" style="max-width: 60%;padding-right:0">
          <p class="paragrafo" align="center" style="font-size: 1.7em;">Meus pets cadastrados</p>
           ...
           <img src="<?php echo e(asset($pet->nmImgPet)); ?>" id='img' style='border:2px solid black; height: 93px; width: 100px;'/>
       ...
       <div id="mensagem" class="divdir" style="padding-right: 0;display:none;max-width: 53%;border:1px solid black"><br><br>
        ...
        <p>
           <img src="<?php echo e(asset('image/user_photo/photo_padrao.png')); ?>" align="left" class="imgsPerfil" id="foto">&nbsp;<label class="usuario" style=""></label>&nbsp; 
           <label class="usuario" align="right" style=""></label><img src="<?php echo e(asset('image/user_photo/photo_padrao.png')); ?>" align="right" class="imgsPerfil" style='margin-right:17px;margin-left: 0' id="foto"> 
        </p><br>
