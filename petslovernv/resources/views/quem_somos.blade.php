...
<section>
  	<div class="geral clearfix" align="center" style="">

  	  <p class="paragrafos" align="center" style="">Quem Somos</p><br><br>

  		<div class="conteudo" style="margin:auto;"> 

  		<div class="divesq" style=""><!-- max-width: 41.9207317%;550 / 1312-->
       ...
       <div class="divdir" style=""><!-- 950 / 1312-->
        ...
        <img src="{{ asset('image/equipe.png')}}" style="border:2px solid #B0E0E6"> 
        <h4 align="center">Equipe Pet's Lover</h4>  
       </div>
      
        <div style="clear:both;width:97.25722758%;"><br><br>
