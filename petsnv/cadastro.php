   ...
   ?>-->
                    <div class="divesq" style=""> <!-- max-width: 45.73170732% 650 / 1312-->
                       <form id="formc" action="grava_cadastro.php" name="cadastro" method="POST" enctype="multipart/form-data" onsubmit="return btCadastrar()">               
                           ...
                           <label class="campos">Imagens de até 2MB</label>
                             <div id="imgs">                               
                                <a href="#">
                                <img src="img/padrao.jpg" style='border:1px solid black' height="95px" width="74px" id="foto" >
                                <img src="img/padrao.jpg"  style='border:1px solid black' height="95px" width="74px" id="foto2">
                                <img src="img/padrao.jpg" style='border:1px solid black' height="95px" width="74px" id="foto3">
                                <img src="img/padrao.jpg" style='border:1px solid black' height="95px" width="74px" id="foto4">
                                <img src="img/padrao.jpg" style='border:1px solid black' height="95px" width="74px" id="foto5">                                   
                                </a>
                              </div>
                              <div>
                                <input type="file" value="fileToUpload" style="font-size:1.2em" name="fileToUpload" tabindex="9" id="imagemSub" size="38" accept="image/gif, image/jpeg, image/jpg, image/png" onchange="return is_img(this.id);"/>
                              </div><br><br>
                              <div id="hint"></div>
                    </div>
                    ...
                    <div class="divdir" style=""> <!-- /* 45 / 1312 */-->
                         ...
                         <label class="campos">Imagens de até 2MB</label>
                             <div id="fotos">
                                <a href="#">
                                <img src="img/doadores.png" style='border:1px solid black' height="93px" width="84px" id="foto" >
                                </a>
                              </div>
                              <div>
