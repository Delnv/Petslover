...
?>
<section>
    <div align="center" class="geral clearfix" style="background-color:white;opacity:0.9;filter:alpha(opacity=60);border-radius:0px">
  		...
  		<td colspan="2" align="center">
                ...
                while ($linha = mysqli_fetch_assoc($result)) {
                    ...
                    <div class="mens-itself" max-width="40%">
                        ...
                        <a href="ver_mensagem.php?men=<?php echo $row; ?>" class="mens" name="mensagem" onclick="javascript : location.href='ver_mensagem.php'"><?php echo   "&nbsp &nbsp &nbsp  ".$linha["nmPet"] .
              "&nbsp"."<b style='font-size:1.6em'>.</b>"."&nbsp" .$linha["statusMensagem"] . "&nbsp &nbsp &nbsp";
                    ?></a>
                    </div>
                    <?php
                    $i++;
